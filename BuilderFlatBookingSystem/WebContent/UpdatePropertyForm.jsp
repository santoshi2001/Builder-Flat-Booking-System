...
<body class="container">
    ...
    <center><h1>Update Property</h1></center>
    <form action="UpdatePropertyServlet" method="post">
   
      
      <div class="form-group">
      <label  class="form-label mt-4">Property Name</label>
      <input type="text" class="form-control" name="pname" value="<%= request.getParameter("pname") %>">
      </div>
      ...
      <input type="text" class="form-control" name="pdetails" value="<%= request.getParameter("pdetail") %>">
      </div>
      
      <div class="form-group">
      <label class="form-label mt-4">Property Location</label>
      <input type="text" class="form-control" name="plocation" value="<%= request.getParameter("plocation") %>">
      </div>
      
      <div class="form-group">
      <label  class="form-label mt-4">Property Area</label>
      <input type="text" class="form-control" name="parea" value="<%= request.getParameter("parea") %>">
      </div>
      
      <div class="form-group">
      <label  class="form-label mt-4">No. Of Floors in Property</label>
      <input type="text" class="form-control" name="pfloors" value="<%= request.getParameter("pNoFloors") %>">
      </div>
